...
<div class="page-body">
    <div class="container-xl">
        <div class="row">
            <div class="col-md-6 col-xl-3" bis_skin_checked="1">
                <div class="card card-sm" bis_skin_checked="1">
                  <div class="card-body" bis_skin_checked="1">
                    <div class="row align-items-center" bis_skin_checked="1">
                      ...
                      <div class="col" bis_skin_checked="1">
                        <div class="font-weight-medium" bis_skin_checked="1">{{ $rekappresensi->jmlhadir }}</div>
                        <div class="text-secondary" bis_skin_checked="1">Karyawan Hadir</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card card-sm" bis_skin_checked="1">
                  <div class="card-body" bis_skin_checked="1">
                    <div class="row align-items-center" bis_skin_checked="1">
                      ...
                      <div class="col" bis_skin_checked="1">
                        <div class="font-weight-medium" bis_skin_checked="1">{{ $rekappresensi->jmltelat }}</div>
                        <div class="text-secondary" bis_skin_checked="1">Karyawan Terlambat</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card card-sm" bis_skin_checked="1">
                  <div class="card-body" bis_skin_checked="1">
                    <div class="row align-items-center" bis_skin_checked="1">
                      ...
                      <div class="col" bis_skin_checked="1">
                        <div class="font-weight-medium" bis_skin_checked="1">{{ $rekapizin->jmlsakit !== null ? $rekapizin->jmlsakit : 0 }}</div>
                        <div class="text-secondary" bis_skin_checked="1">Karyawan Sakit</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card card-sm" bis_skin_checked="1">
                  <div class="card-body" bis_skin_checked="1">
                    <div class="row align-items-center" bis_skin_checked="1">
                      ...
                      <div class="col" bis_skin_checked="1">
                        <div class="font-weight-medium" bis_skin_checked="1">{{ $rekapizin->jmlizin !== null ? $rekapizin->jmlizin : 0 }}</div>
                        <div class="text-secondary" bis_skin_checked="1">Karyawan Izin</div>
                      </div>
                    </div>
                  </div>
                </div>
